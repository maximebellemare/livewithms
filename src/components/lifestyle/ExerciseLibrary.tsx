...
const EXERCISES: MSExercise[] = [
  ...
  {
    id: "hippotherapy", name: "Hippotherapy (Horse Therapy)", category: "balance", fatigueLevel: "moderate",
    duration: "30–45 min", heatSafe: false,
    benefits: ["Core stability", "Balance", "Posture", "Emotional wellbeing"],
    description: "Therapeutic horse riding where the horse's movement stimulates the rider's core, pelvis, and balance systems.",
    msTips: "The horse's gait mimics human walking patterns, retraining your nervous system. Helmets and side-walkers ensure safety. Many riders report improved mood and motivation.",
  },
  {
    id: "rock-climbing", name: "Adaptive Indoor Climbing", category: "strength", fatigueLevel: "high",
    duration: "15–30 min", heatSafe: true,
    benefits: ["Grip strength", "Problem-solving", "Full-body strength", "Confidence"],
    description: "Indoor climbing walls with adaptive routes and auto-belay systems, scaled to your ability level.",
    msTips: "Only for well-rested days with good grip strength. Auto-belay systems handle safety. Focus on easy routes. The cognitive challenge of route-finding exercises your brain too.",
  },
  {
    id: "trampoline", name: "Mini Trampoline (Rebounding)", category: "balance", fatigueLevel: "moderate",
    duration: "5–15 min", heatSafe: true,
    benefits: ["Lymphatic drainage", "Balance", "Bone density", "Fun factor"],
    description: "Gentle bouncing on a mini trampoline with a stability bar — low impact but activates the whole body.",
    msTips: "Always use a trampoline with a handlebar. Start with just standing and gentle weight shifting. Even small bounces improve lymphatic flow and vestibular function.",
  },
  {
    id: "theraband-upper", name: "TheraBand Upper Body", category: "strength", fatigueLevel: "low",
    duration: "10–15 min", heatSafe: true,
    benefits: ["Shoulder stability", "Arm strength", "Posture correction", "Rotator cuff health"],
    description: "Targeted upper body exercises with TheraBands — shoulder rotations, chest pulls, and bicep curls with variable resistance.",
    msTips: "Attach the band to a door handle for seated exercises. Yellow (lightest) bands are a great starting point. Focus on shoulder blade squeezes to combat forward-leaning posture.",
  },
  {
    id: "step-ups", name: "Supported Step-Ups", category: "strength", fatigueLevel: "high",
    duration: "5–10 min", heatSafe: true,
    benefits: ["Leg power", "Hip stability", "Stair readiness", "Functional strength"],
    description: "Stepping up onto a low platform (10–20 cm) while holding a railing or counter for support.",
    msTips: "Start with the lowest step height. Always have something to hold. Alternate legs. Directly trains the motion needed for stairs and curbs in daily life.",
  },
  {
    id: "arm-ergometer", name: "Arm Ergometer (Hand Bike)", category: "cardio", fatigueLevel: "moderate",
    duration: "10–20 min", heatSafe: true,
    benefits: ["Upper body cardio", "Shoulder endurance", "Circulation", "Seated exercise"],
    description: "A pedal machine for your arms — provides cardiovascular exercise without using your legs at all.",
    msTips: "Perfect for days when legs are too fatigued or spastic. Provides genuine cardio without standing. Place on a table for easy access. Start with zero resistance.",
  },
  {
    id: "supine-exercises", name: "Supine (Lying Down) Exercises", category: "flexibility", fatigueLevel: "low",
    duration: "10–20 min", heatSafe: true,
    benefits: ["Zero fall risk", "Spasticity relief", "Hip mobility", "Accessible on bad days"],
    description: "Exercises performed entirely lying on your back — leg slides, bridges, hip rotations, and gentle core work.",
    msTips: "The safest position for exercise — zero fall risk and gravity-assisted. Do these on your worst fatigue days when even sitting feels hard. A yoga mat on the floor is all you need.",
  },
  {
    id: "balance-board", name: "Balance Board Training", category: "balance", fatigueLevel: "moderate",
    duration: "5–10 min", heatSafe: true,
    benefits: ["Proprioception", "Ankle stability", "Core engagement", "Reaction time"],
    description: "Standing on a wobble board or balance disc to challenge your body's stability reflexes and ankle strength.",
    msTips: "Place the board between two counters for hand support. Start with 30-second intervals. Progressively reduce hand support as you improve. Not for use during flares.",
  },
  {
    id: "water-aerobics", name: "Water Aerobics Class", category: "cardio", fatigueLevel: "moderate",
    duration: "30–45 min", heatSafe: true,
    benefits: ["Social connection", "Full-body workout", "Fun", "Instructor-guided"],
    description: "Group exercise class in a pool — choreographed movements to music with an instructor guiding intensity levels.",
    msTips: "The social aspect combats MS-related isolation. Let the instructor know about your MS so they can offer modifications. Water resistance replaces weights safely.",
  },
  {
    id: "neck-exercises", name: "Neck & Shoulder Release", category: "flexibility", fatigueLevel: "low",
    duration: "5–10 min", heatSafe: true,
    benefits: ["Headache relief", "Posture", "Tension release", "Neck mobility"],
    description: "Gentle neck rotations, chin tucks, shoulder shrugs, and upper trapezius stretches to relieve tension.",
    msTips: "MS-related posture changes and screen time cause neck tension. Do these between activities throughout the day. Avoid full neck circles — half circles are safer.",
  },
  {
    id: "desk-exercises", name: "Desk & Workplace Exercises", category: "strength", fatigueLevel: "low",
    duration: "5–10 min", heatSafe: true,
    benefits: ["Break up sitting", "Circulation", "Energy boost", "No equipment"],
    description: "Micro-exercises you can do at your desk — seated marches, desk push-ups, chair squats, and wrist stretches.",
    msTips: "Set a timer every 45 minutes to move. Even small movements prevent stiffness and fatigue from prolonged sitting. Wrist circles help if you have hand numbness or tingling.",
  },
  {
    id: "bedtime-routine", name: "Bedtime Relaxation Routine", category: "flexibility", fatigueLevel: "low",
    duration: "10–15 min", heatSafe: true,
    benefits: ["Better sleep", "Spasticity relief", "Relaxation", "Night cramp prevention"],
    description: "A calming sequence of gentle stretches, progressive muscle relaxation, and breathing done in bed before sleep.",
    msTips: "Nighttime spasticity and restless legs are common in MS. This routine can reduce both. Focus on calf and hamstring stretches. Pair with deep breathing for best results.",
  },
];
